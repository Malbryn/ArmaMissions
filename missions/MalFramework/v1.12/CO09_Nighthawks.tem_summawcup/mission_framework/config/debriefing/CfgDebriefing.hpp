...
class MissionSuccess {
    ...
    subtitle = "Objectives completed";          // Closing shot - Short description
    description = "You managed to complete your objectives successfully. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Most objectives completed";
    description = "You managed to complete most of your objectives. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "Some objectives completed";
    description = "You didn't manage to complete every objective. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "No objectives completed";
    description = "You failed to complete your objectives. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
...
class ExfilFail {
    title = "Exfil failed";
    subtitle = "You were left behind";
    description = "You didn't manage to exfil in time and got left behind. Your unit will probably get captured and tortured by the North Koreans.";
    pictureBackground = "";
    picture = "KIA";
    pictureColor[] = {0.6, 0.1, 0.2, 1};
};
