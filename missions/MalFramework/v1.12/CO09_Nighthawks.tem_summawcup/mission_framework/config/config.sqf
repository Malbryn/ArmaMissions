...
EGVAR(end_conditions,extTask) = "t5";  // Extraction task that will be automatically completed (empty string disables this functionality)
...
// Countdown
GVARMAIN(moduleCountdown) = true;  // Coop & TvT
...
EGVAR(intro_text,title) = "NIGHTHAWKS";  // Title
EGVAR(intro_text,date) = "2019-01-27 0500";  // Date
EGVAR(intro_text,location) = "Korean Demilitarized Zone";  // Location
EGVAR(intro_text,delay) = 8;  // Delay after loading in
