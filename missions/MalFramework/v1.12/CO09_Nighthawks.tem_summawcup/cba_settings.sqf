...
force force emr_main_maxClimbHeight = 1.75;
...
force force grad_trenches_functions_shortEnvelopeRemovalTime = 7;
...
force force grenades_hatches_main_blacklistVehiclesInheritanceSetting = "['CfgVehicles']";
...
force force Vcm_AISkills_East_spotDistance = 0.3;
force force Vcm_AISkills_East_spotTime = 0.3;
...
force force Vcm_AISkills_General_spotDistance = 0.3;
force force Vcm_AISkills_General_spotTime = 0.3;
...
force force Vcm_AISkills_Resistance_spotDistance = 0.3;
force force Vcm_AISkills_Resistance_spotTime = 0.3;
...
force force Vcm_AISkills_West_spotDistance = 0.3;
force force Vcm_AISkills_West_spotTime = 0.3;
