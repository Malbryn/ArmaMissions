...
class MissionSuccess {
    ...
    subtitle = "The Iraqis are falling back";          // Closing shot - Short description
    description = "You managed to secure every objective and the Iraqis are now falling back. Good job guys.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "The Iraqis are falling back";
    description = "You managed to secure almost every objective and most of the Iraqi forces are falling back. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "The Iraqis are still present";
    description = "You didn't manage to capture most of the objectives. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "Total defeat";
    description = "You didn't manage to achieve anything. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
