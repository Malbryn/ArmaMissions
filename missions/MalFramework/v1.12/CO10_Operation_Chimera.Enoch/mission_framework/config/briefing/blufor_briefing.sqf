...
<br/>
<br/><font color='#21749c' size='14' face='PuristaSemiBold'>Livonian Special Operations Forces</font>
<br/>SABRE - 8x infantrymen
<br/>RAVEN - 2x pilots
ENDTAB;

NEWTAB("II. Situation")
<br/><font color='#21749c' size='18' face='PuristaBold'>SUMMARY</font>
<br/>We recieved a report about an accident at the chemical factory near Sitnik. Intel suggests that the factory was overtaken by local insurgents who used it to produce chemical weapons.
<br/>
<br/>
...
<br/>We are fighting local insurgents, they use older Soviet equipment combined with various camo patterns.
<br/>
...
<br/>We expect no civilians in the AO, assume everyone is hostile.
ENDTAB;

NEWTAB("III. Mission:")
<br/><font color='#21749c' size='18' face='PuristaBold'>MISSION INTENT</font>
<br/>Your objective is to assault and secure the chemical factory. Keep an eye out for possible intel and expect further tasking.
ENDTAB;
...
<br/>- Unlimited, rolling respawn
<br/>- 120-second timer
<br/>
<br/>
<br/><font color='#21749c' size='14' face='PuristaSemiBold'>Asset respawn</font>
<br/>- ESSS variant has no respawns
<br/>- 3 spare birds are available with no pylons
<br/>
<br/><font color='#21749c' size='14' face='PuristaSemiBold'>Reinsertion</font>
<br/>While the ESSS bird is up, use the teleport pole to TP into that bird. If the ESSS bird is no longer available, the unarmed bird will do respawn runs.
<br/>
<br/>
...
<br/>Major success: 100% completion
<br/>Minor success: 66% completion
<br/>
<br/><font color='#21749c' size='14' face='PuristaSemiBold'>Failure</font>
<br/>Minor failure: 33% completion
<br/>Major failure: 0% completion
<br/>
<br/>
<br/><font color='#21749c' size='18' face='PuristaBold'>RESTRICTIONS</font>
<br/>- Don't loot AT while you have CAS available
<br/>- Enemy vehicles cannot be taken
<br/>
<br/>
...
<br/>- This mission uses the CBRN module, which means you have to keep on eye on the contamination level. Your detector will start beeping if the contamination reaches the set threshold. The beeping can be disabled in your ACE self-interaction, you can also set a threshold for the beeping as well.
<br/>- If you are in a contaminated zone, equip your gas mask which will provide protection.
<br/>- Symptoms: pain, loss of blood and stamina.
ENDTAB;
