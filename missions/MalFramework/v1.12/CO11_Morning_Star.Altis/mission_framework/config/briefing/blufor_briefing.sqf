...
<br/>Can be requested by Alpha leadership (SL or 2iC)
<br/>
<br/>
...
<br/>- The ACRE module hasn't been maintained since I implemented it, it might break
ENDTAB;
