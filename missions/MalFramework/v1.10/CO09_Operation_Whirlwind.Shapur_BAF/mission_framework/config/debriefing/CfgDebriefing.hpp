...
class MissionSuccess {
    ...
    subtitle = "The industrial area is secured";          // Closing shot - Short description
    description = "You successfully cleared the area. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "The area is mostly secured";
    description = "You successfully cleared most of the area.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "The area is not secure";
    description = "The area was not secured properly. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    description = "You didn't manage to complete any of the objectives. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
