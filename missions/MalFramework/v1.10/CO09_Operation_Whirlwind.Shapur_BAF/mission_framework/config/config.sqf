...
GVARMAIN(serverViewDistance) = 300;  // Server view distance (= AI view distance)
...
EGVAR(intro_text,title) = "OPERATION WHIRLWIND";  // Title
EGVAR(intro_text,date) = "1720 4th November, 2007";  // Date
EGVAR(intro_text,location) = "SHAPUR PROVINCE, AFGHANISTAN";  // Location
