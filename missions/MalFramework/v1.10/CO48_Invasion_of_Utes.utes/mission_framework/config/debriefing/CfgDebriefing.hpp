...
class MissionSuccess {
    ...
    description = "You have successfully captured the island. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Most of the island has been captured";
    description = "You have successfully captured most of the island. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "Island partially captured";
    description = "You have captured half of the island. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    description = "You failed to complete any task. Mission failed.";
    pictureBackground = "";
    picture = "KIA";
