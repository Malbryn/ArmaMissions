...
force diwako_dui_radar_sortType = "custom"; // TODO
...
// LAMBS Danger
force force lambs_danger_combatShareRange = 100;
...
force force lambs_danger_radio_EAST = 100;
force force lambs_danger_radio_GUER = 100;
force force lambs_danger_radio_shout = 30;
force force lambs_danger_radio_WEST = 100;
...
force force Vcm_AISkills_East_commanding = 0.4;
force force Vcm_AISkills_East_courage = 0.4;
force force Vcm_AISkills_East_general = 0.4;
force force Vcm_AISkills_East_reloadSpeed = 0.4;
force force Vcm_AISkills_East_spotDistance = 0.2;
force force Vcm_AISkills_East_spotTime = 0.2;
...
force force Vcm_AISkills_General_commanding = 0.4;
force force Vcm_AISkills_General_courage = 0.4;
force force Vcm_AISkills_General_general = 0.4;
force force Vcm_AISkills_General_reloadSpeed = 0.4;
force force Vcm_AISkills_General_spotDistance = 0.2;
force force Vcm_AISkills_General_spotTime = 0.2;
...
force force Vcm_AISkills_Resistance_commanding = 0.4;
force force Vcm_AISkills_Resistance_courage = 0.4;
force force Vcm_AISkills_Resistance_general = 0.4;
force force Vcm_AISkills_Resistance_reloadSpeed = 0.4;
force force Vcm_AISkills_Resistance_spotDistance = 0.2;
force force Vcm_AISkills_Resistance_spotTime = 0.2;
...
force force Vcm_AISkills_West_commanding = 0.4;
force force Vcm_AISkills_West_courage = 0.4;
force force Vcm_AISkills_West_general = 0.4;
force force Vcm_AISkills_West_reloadSpeed = 0.4;
force force Vcm_AISkills_West_spotDistance = 0.2;
force force Vcm_AISkills_West_spotTime = 0.2;
