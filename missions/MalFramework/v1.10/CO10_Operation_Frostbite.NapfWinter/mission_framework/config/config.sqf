...
EGVAR(cover_map,aoMarker) = "mrk_aoLimitAll";  // AO marker
...
EGVAR(intro_text,title) = "OPERATION FROSTBITE";  // Title
EGVAR(intro_text,date) = "2015-01-07 18:10";  // Date
EGVAR(intro_text,location) = "RUS Airbase, Napf Island";  // Location
...
EGVAR(unit_tracking,refreshInterval) = 2;  // Refresh rate in seconds (min. value = 1)
