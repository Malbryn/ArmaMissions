...
class MissionSuccess {
    ...
    subtitle = "All objectives completed";          // Closing shot - Short description
    description = "You successfully disarmed the explosives and rescued the VIP. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Most of the objectives completed";
    description = "You almost managed to complete all objectives. Good job anyway.";
    pictureBackground = "";
    picture = "mil_flag";
...
class TimeLimitMinorFail {
    title = "Minor Defeat";
    subtitle = "Time limit reached";
    description = "Not good enough. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
    pictureColor[] = {0.9, 0, 0, 1};
};
