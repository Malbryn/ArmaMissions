...
class MissionSuccess {
    ...
    subtitle = "Anti-air emplacements destroyed";          // Closing shot - Short description
    description = "The German's air defences have been destroyed. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Anti-air emplacements weakened";
    description = "The German's air defences have been weakened. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "Anti-air emplacements weakened";
    description = "The German's air defences have been weakened but most of them are still standing. We'll get them next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "Your platoon have been defeated";
    description = "Your platoon have been seriously defeated.";
    pictureBackground = "";
    picture = "KIA";
