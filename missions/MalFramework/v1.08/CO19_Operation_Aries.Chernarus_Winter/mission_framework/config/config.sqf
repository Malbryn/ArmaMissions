...
EGVAR(intro_text,title) = "OPERATION ARIES";  // Title
EGVAR(intro_text,date) = "0730 January 26, 2020";  // Date
EGVAR(intro_text,location) = "NW Airfield, Chernarus";  // Location
...
EGVAR(snowfall,maxDensity) = 10;  // Intensity of the snowfall
