...
class MissionSuccess {
    ...
    subtitle = "The island has been captured";          // Closing shot - Short description
    description = "The US troops managed to capture the island. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "The island has been almost captured";
    description = "The US troops managed to almost fully capture the island. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "The island is still under JAP control";
    description = "The US troops have made very little progress. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    description = "The Japanese managed to repel the US troops. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
