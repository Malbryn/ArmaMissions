...
class MissionSuccess {
    ...
    subtitle = "You managed to escape";                    // Closing shot - Short description
    description = "You successfully killed the HVT and destroyed the armour depot. Good job lads.";                 // Debriefing - Summary of the mission
...
class MissionFail {
    ...
    subtitle = "You failed to complete every objective.";
