...
MF_var_end_ex_threshold = 50;  // 50 means 50% of the players should be inside the exfil marker
MF_var_end_task_threshold = 100;  // 66 means 66% of the tasks should be completed inn order to call it a mission success
...
// Time acceleration
MF_var_time_acceleration = 0.1;  // Time acceleration between 0.1 - 120
...
MF_var_cover_colour = "ColorGreen";  // https://community.bistudio.com/wiki/Arma_3_CfgMarkerColors
...
// INTRO TEXT
MF_var_title = "OPERATION DAGGER";
MF_var_date = "06:10 March 18th, 1944";
MF_var_location = "West of Neaville, France";
