...
class MissionSuccess {
    ...
    description = "Your platoon managed to clear the designated areas and secured the bridge. The Germans are falling back. Good job, fellas.";     // Debriefing - Summary of the mission
...
class MissionFail {
    ...
    subtitle = "The Germans are still holding their lines";
    description = "Your platoon did not manage to seize every sector and had to exfil before completing every task. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
