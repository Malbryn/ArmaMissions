...
EGVAR(intro_text,title) = "ROUTE CHERNOGORSK";  // Title
...
EGVAR(supply_drop,supplyDropPlane) = "RHS_AN2";  // Plane or helicopter used for the supply drop
...
EGVAR(unit_tracking,refreshInterval) = 10;  // Refresh rate in seconds (min. value = 1)
