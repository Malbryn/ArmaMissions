...
class MissionSuccess {
    ...
    subtitle = "HVT is secured";          // Closing shot - Short description
    description = "You managed to secure the Scud missile launch sites and exfil with the enemy HVT. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Completed most objectives";
    description = "You successfully completed most of the objectives. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    ...
    description = "You failed to complete most of the objectives. Better luck next time.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "Too bad";
    description = "Major failure. Maybe next time.";
    pictureBackground = "";
    picture = "KIA";
