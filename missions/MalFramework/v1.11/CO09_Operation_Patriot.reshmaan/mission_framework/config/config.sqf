...
EGVAR(intro_text,title) = "OPERATION PATRIOT";  // Title
EGVAR(intro_text,date) = "1991-01-27 02:00";  // Date
EGVAR(intro_text,location) = "FOB Jackson, Reshmaan Province, Iraq";  // Location
...
EGVAR(supply_drop,supplyDropPlane) = "UK3CB_CW_US_B_EARLY_C130J_CARGO";  // Plane or helicopter used for the supply drop
