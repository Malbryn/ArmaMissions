...
EGVAR(respawn,timer) = 180;  // Respawn timer in seconds
...
EGVAR(ai_skills,skillSet) = [
    ...
    0.4,  // Aiming Accuracy (Higher = Better)
...
EGVAR(intro_text,title) = "LOOSE ENDS";  // Title
EGVAR(intro_text,date) = "2018-01-10 09:00";  // Date
EGVAR(intro_text,location) = "Ihantala, 30km North of Chernarus";  // Location
...
EGVAR(reinsertion,HABObject) = "Land_tent_east";  // Object used as the platoon HAB
...
EGVAR(supply_drop,supplyDropPlane) = "RHS_Mi8mt_Cargo_vvs";  // Plane or helicopter used for the supply drop
