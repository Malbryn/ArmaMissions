...
class MissionSuccess {
    ...
    subtitle = "Enemies are falling back";          // Closing shot - Short description
    description = "You have managed to capture every objective. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Enemies are falling back";
    description = "You have managed to capture most of the objectives. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "Enemies are still holding out";
    description = "You didn't manage to capture most of the objectives and the enemies are still holding out.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "Enemies are still holding out";
    description = "You didn't manage to capture anything. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
