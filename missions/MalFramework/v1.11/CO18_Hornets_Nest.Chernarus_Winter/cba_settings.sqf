...
// LAMBS Main
force force lambs_main_combatShareRange = 300;
...
force force lambs_main_radioEast = 400;
force force lambs_main_radioGuer = 400;
force force lambs_main_radioShout = 60;
force force lambs_main_radioWest = 400;
