...
EGVAR(intro_text,title) = "OPERATION HORNET'S NEST";  // Title
EGVAR(intro_text,date) = "1988-01-30 0700";  // Date
EGVAR(intro_text,location) = "Nizhnoye, East Chernarus";  // Location
...
EGVAR(snowfall,maxDensity) = 25;  // Intensity of the snowfall
