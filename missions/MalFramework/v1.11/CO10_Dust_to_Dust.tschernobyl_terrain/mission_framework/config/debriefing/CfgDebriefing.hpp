...
class MissionSuccess {
    title = "Mission End";              // Closing shot - Main title
    subtitle = "The nuke was detonated";          // Closing shot - Short description
    description = "The Zone had to be purged to get rid of the mutants and anomalies that escaped from the Facility. Unfortunatelly, some of your Comrades had to be sacrificed. They will be always remembered. Those who survived will live for another day. But what kind of world will wait for them after the nuclear fallout? They will see it next year maybe...";    // Debriefing - Summary of the mission
