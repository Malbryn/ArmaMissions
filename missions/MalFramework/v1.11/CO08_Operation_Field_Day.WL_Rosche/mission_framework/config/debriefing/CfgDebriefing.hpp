...
class MissionSuccess {
    ...
    subtitle = "You saved the farm";          // Closing shot - Short description
    description = "Jeremy's Diddly Squat Farm is safe now, thanks to you. Good job, chaps.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "You completed most tasks";
    description = "You managed to deal with most of the angry locals. Good job, chaps.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    subtitle = "Clarkson is KIA";
    description = "You killed Jeremy Clarkson. Not cool.";
    pictureBackground = "";
    picture = "KIA";
