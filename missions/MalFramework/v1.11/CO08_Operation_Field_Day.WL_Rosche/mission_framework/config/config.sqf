...
EGVAR(respawn,timer) = 3 MINUTES;  // Respawn timer in seconds
...
EGVAR(intro_text,title) = "OPERATION FIELD DAY";  // Title
EGVAR(intro_text,date) = "2020-08-11 08:00";  // Date
EGVAR(intro_text,location) = "Chipping Norton, England";  // Location
...
EGVAR(reinsertion,RPObject) = "Land_Trough_01_F";  // Object used as the squad rally point
