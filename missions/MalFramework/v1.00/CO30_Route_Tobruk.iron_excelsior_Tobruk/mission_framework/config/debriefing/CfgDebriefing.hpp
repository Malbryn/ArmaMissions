...
class MissionSuccess {
    ...
    description = "You've successfully pushed back the front line. The Germans are now falling back. You managed to relieve the city of Tobruk. Good job lads.";                 // Debriefing - Summary of the mission
...
class CasualtyLimit {
    ...
    description = "Your platoon was completely wiped out. Better luck next time.";
    pictureBackground = "";
    picture = "KIA";
    pictureColor[] = {0.6, 0.1, 0.2, 1};
};
