...
class MissionSuccess {
    ...
    subtitle = "You escaped from Livonia";              // Closing shot - Short description
    description = "You successfully managed to escape from Livonia.";    // Debriefing - Summary of the mission
