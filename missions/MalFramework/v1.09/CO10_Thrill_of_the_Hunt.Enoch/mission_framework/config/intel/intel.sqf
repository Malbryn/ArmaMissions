...
// ID: 7
    [
        "SOS transmission",
        "You received an SOS transmission from a friendly Mi-8 that tried to escape when the disaster happened. It crash landed ~1km north of this location. The pilot passed out before the crash, apparently 'his infection got worse'.<br/><br/>The sender's last message before he cut out was: 'Please send help. I'm Dr. Borichev, the lead scientist of the...(radio silence).",
        5,
        false,
        false
    ],
...
// ID: 13
    [
        "Measurement data",
        "TEST SUBJECT 69<br/><br/>LAST MEASURMENT:<br/>19:30 October 31rd, 2020<br/><br/>DEVICE READING:<br/>3.6<br/><br/>STATUS:<br/>Not great, not terrible",
        2,
        false,
        false
    ],
