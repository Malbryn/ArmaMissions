...
class MissionFail {
    ...
    subtitle = "Time's up";
    description = "We ran out of time. Nobody wins.";
    pictureBackground = "";
    picture = "KIA";
...
class PlayerCasLimitBlufor {
    title = "Norwegian Army Win";
    subtitle = "Russian VDV suffered serious casulties";
    description = "Russian VDV suffered serious casualties. Norwegian Army win.";
    pictureBackground = "";
    picture = "b_unknown";
    pictureColor[] = {0, 0.3, 0.6, 1};
};
...
class PlayerCasLimitRedfor {
    title = "Russian VDV Win";
    subtitle = "Norwegian Army suffered serious casulties";
    description = "Norwegian Army suffered serious casualties. Russian VDV win.";
    pictureBackground = "";
    picture = "o_unknown";
    pictureColor[] = {0.5, 0, 0, 1};
};
