...
force force diwako_dui_nametags_deadRenderDistance = 3;
...
Vcm_AISkills_General_commanding = 0.4;
Vcm_AISkills_General_courage = 0.4;
Vcm_AISkills_General_general = 0.4;
Vcm_AISkills_General_reloadSpeed = 0.4;
Vcm_AISkills_General_spotDistance = 0.4;
Vcm_AISkills_General_spotTime = 0.4;

// VCOM AI West Skill
Vcm_AISkills_West_AimingAccuracy = 0.2;
Vcm_AISkills_West_aimingShake = 0.3;
Vcm_AISkills_West_aimingSpeed = 0.3;
Vcm_AISkills_West_commanding = 0.4;
Vcm_AISkills_West_courage = 0.4;
Vcm_AISkills_West_general = 0.4;
...
Vcm_AISkills_East_commanding = 0.4;
Vcm_AISkills_East_courage = 0.4;
Vcm_AISkills_East_general = 0.4;
...
Vcm_AISkills_Resistance_aimingShake = 03;
Vcm_AISkills_Resistance_aimingSpeed = 0.3;
Vcm_AISkills_Resistance_commanding = 0.4;
Vcm_AISkills_Resistance_courage = 0.4;
Vcm_AISkills_Resistance_general = 0.4;
