...
class MissionSuccess {
    ...
    subtitle = "VC and NVA camps captured";          // Closing shot - Short description
    description = "You have successfully cleared the VC and NVA camps. Good job.";    // Debriefing - Summary of the mission
