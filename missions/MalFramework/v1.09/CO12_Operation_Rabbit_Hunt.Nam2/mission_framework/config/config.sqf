...
EGVAR(ao_limit,timerAir) = 25;  // Timer for any air vehicle (-1: disabled)
...
EGVAR(custom_channel,channelName) = "Flight channel";  // Name of the channel
...
EGVAR(intro_text,title) = "OPERATION RABBIT HUNT";  // Title
EGVAR(intro_text,date) = "0500 22 May, 1968";  // Date
EGVAR(intro_text,location) = "Firebase Mac, 5km North of Saigon";  // Location
