...
EGVAR(end_conditions,playerThreshold) = 75;  // Percentage of the alive players that have to be in the extraction zone
...
// Respawn rules
GVARMAIN(respawnTimer) = 150;  // Respawn timer in seconds
...
EGVAR(ai_skills,skillSet) = [
    ...
    0.3,  // Reload Speed (Higher = Faster)
...
EGVAR(intro_text,title) = "Operation Grach";  // Title
EGVAR(intro_text,date) = "1700 7th August, 1982";  // Date
EGVAR(intro_text,location) = "North Takistan, Afghanistan";  // Location
...
EGVAR(reinsertion,HABObject) = "CampEast_EP1";  // Object used as the platoon HAB
...
EGVAR(supply_drop,supplyDropPlane) = "UK3CB_CW_SOV_O_EARLY_Antonov_AN2";  // Plane or helicopter used for the supply drop
