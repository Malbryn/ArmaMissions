...
class MissionSuccess {
    ...
    subtitle = "The friendly units have been rescued";          // Closing shot - Short description
    description = "We have managed to secure the oil field and the refinery. We also managed to rescue the friendly units too. Good job, Comrades.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "The oil field has been captured";
    description = "We have managed to secure the oil field and the refinery. Good job, Comrades.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "The oil field was partially secured";
    description = "We only managed to partially secure the oil field.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MissionFail {
    ...
    description = "We didn't manage to do complete any objective.";
    pictureBackground = "";
    picture = "KIA";
...
class TimeLimitMinorSuccess {
    ...
    description = "We managed to complete some objectives but not all. We need to be faster next time.";
    pictureBackground = "";
    picture = "mil_flag";
    pictureColor[] = {0, 0.8, 0, 1};
};
