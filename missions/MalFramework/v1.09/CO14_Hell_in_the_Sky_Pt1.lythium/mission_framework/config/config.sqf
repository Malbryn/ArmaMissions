...
GVARMAIN(respawnTickets) = 3;  // Individual respawn tickets (-1: tickets disabled, 0: respawns disabled)
...
EGVAR(intro_text,title) = "HELL IN THE SKY - PART 1";  // Title
EGVAR(intro_text,date) = "1645 December 7th, 2008";  // Date
EGVAR(intro_text,location) = "Near Kalae Noowi, Afghanistan";  // Location
...
EGVAR(reinsertion,RPObject) = "Misc_Backpackheap_EP1";  // Object used as the squad rally point
