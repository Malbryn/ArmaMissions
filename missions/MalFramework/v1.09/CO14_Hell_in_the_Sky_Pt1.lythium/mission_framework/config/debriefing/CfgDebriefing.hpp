...
class MissionSuccess {
    ...
    subtitle = "Successful exfil";          // Closing shot - Short description
    description = "The scientists have been rescued and the nuclear device has been secured. Good job.";    // Debriefing - Summary of the mission
...
// Generic - Major Fail - Time limit
class MissionFail {
    title = "Mission Failed";
    subtitle = "Time limit reached";
    description = "We have run out of time. Mission fail.";
    pictureBackground = "";
    picture = "KIA";
    pictureColor[] = {0.6, 0.1, 0.2, 1};
};

// Generic - Major Fail - Retreat
class MissionFailRetreat {
    title = "Mission Failed";
    subtitle = "Our force has been eliminated";
    description = "We have lost our infantry section. Mission fail.";
    pictureBackground = "";
    picture = "KIA";
    pictureColor[] = {0.6, 0.1, 0.2, 1};
};

// Generic - Major Fail - VIP Death
class MissionFailDeath {
    title = "Mission Failed";
    subtitle = "The scientists are KIA";
    description = "The scientists have been killed during the mission. Mission fail.";
    pictureBackground = "";
    picture = "KIA";
    pictureColor[] = {0.6, 0.1, 0.2, 1};
};

// Generic - Major Fail - Nuke detonation
class MissionFailNuke {
    title = "Mission Failed";
    subtitle = "Nuclear explosion";
    description = "The nuclear device exploded during the mission. Mission fail.";
    pictureBackground = "";
    picture = "KIA";
    pictureColor[] = {0.6, 0.1, 0.2, 1};
};
