...
// ID: 0
    [
        ...
        "According to the civilian the city got flooded by the Ukrainians since the arrival of the submarine so they had to leave. He also mentioned a check point that they set up on the main road, north-east of the city near the secondary port.",   // Intel text
        5,               // Pick-up duration
...
// ID: 1
    [
        ...
        "He mentioned a Ukrainian tank patrolling around the railway crossing. It's big and scary, apparently.",   // Intel text
        5,               // Pick-up duration
        false,            // Delete the object after it was acquired
        true             // Share the intel globally
    ]
