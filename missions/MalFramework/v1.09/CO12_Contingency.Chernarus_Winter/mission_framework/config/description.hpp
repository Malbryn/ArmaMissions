...
briefingName = "[CO-12] Contingency";  // Mission name on the mission selection screen (use [CO-XX] or [TVT-XX] where XX is the max. player number)
overviewText = "A small PMC force was hired to sabotage a Ukrainian submarine. // Faction: Blufor PMC // Respawns: unlimited // Assets: 1x Yabhon // JIP: enabled";  // Mission info on the mission selection screen (e.g. mission assets, factions, time limit etc.)
