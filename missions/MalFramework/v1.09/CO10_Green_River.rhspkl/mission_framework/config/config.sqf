...
EGVAR(intro_text,title) = "GREEN RIVER";  // Title
EGVAR(intro_text,date) = "0540 28 June, 1970";  // Date
EGVAR(intro_text,location) = "Phoum Srei Aphsok, Mekong Delta, Vietnam";  // Location
