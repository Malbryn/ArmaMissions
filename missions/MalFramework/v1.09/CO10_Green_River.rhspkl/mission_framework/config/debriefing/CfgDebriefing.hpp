...
class MissionSuccess {
    ...
    subtitle = "Successful patrol";          // Closing shot - Short description
    description = "You successfully completed the patrol, managed to recapture the FOB and rescue the friendly POWs. Good job.";    // Debriefing - Summary of the mission
...
class MinorSuccess {
    title = "Minor Success";
    subtitle = "Successful patrol";
    description = "You successfully completed the patrol. Good job.";
    pictureBackground = "";
    picture = "mil_flag";
...
class MinorFail {
    title = "Minor Defeat";
    subtitle = "Not so successful patrol";
