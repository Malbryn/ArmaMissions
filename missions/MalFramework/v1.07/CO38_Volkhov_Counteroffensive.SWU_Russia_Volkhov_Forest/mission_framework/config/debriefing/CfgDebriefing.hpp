...
class MissionSuccess {
    ...
    subtitle = "The Soviets are falling back";          // Closing shot - Short description
    description = "You have successfully managed to push back the Soviets. Good job.";    // Debriefing - Summary of the mission
...
class MissionFail {
    ...
    description = "The Soviets have totally defeated your platoon";
    pictureBackground = "";
    picture = "KIA";
