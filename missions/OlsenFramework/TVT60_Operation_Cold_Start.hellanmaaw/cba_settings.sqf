...
force force TFAR_givePersonalRadioToRegularSoldier = false;  // Changed
...
force force TFAR_spectatorCanHearEnemyUnits = true;  // Changed
force force TFAR_spectatorCanHearFriendlies = true;
force force TFAR_takingRadio = 0;  // Changed
...
force force TFAR_radioCodesDisabled = false;  // Changed
force force TFAR_AICanHearPlayer = false;

//TFAR Frequency Settings
force force TFAR_setting_defaultFrequencies_sr_west = "100,110,120,130,140,150,160,170,180";
force force TFAR_setting_defaultFrequencies_sr_east = "100,110,120,130,140,150,160,170,180";
force force TFAR_setting_defaultFrequencies_sr_independent = "100,110,120,130,140,150,160,170,180";
...
force force ace_medical_preventInstaDeath = false;  // Changed
...
force force diwako_dui_enable_compass_dir = 1;  // Changed
